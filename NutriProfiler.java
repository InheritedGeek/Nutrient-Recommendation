...
public class NutriProfiler {
	...
	calculateEnergyRequirement() and calculateNutriRequirement() methods.
	*/
	static void createNutriProfile(Person person) {
		//write your code here
		person.recommendedNutrientsList.clear();
		RecommendedNutrient profile = new RecommendedNutrient(ENERGY_NUTRIENT_CODE, person.calculateEnergyRequirement());
		person.recommendedNutrientsList.add(profile);
